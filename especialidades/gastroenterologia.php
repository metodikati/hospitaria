...
<!------------------------Inicia la Parte del Banner-------------->
        ...
        <div class="sec1-gastro">
            <div class="container">
                <div class="especialidadEspe">
                    <div class="col-sm-5 col-sm-offset-2">
                        <h1><span>Gastroenterología</span></h1>
                        <span class="especialidad1">
                            <p> Buscando mejores soluciones para tuy salud.</p> </span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12 pd0">
                ...
                <div class="sec2-chec">
                    <div class="col-sm-7 pd0">
                        <span class="sec1-lineaCirujia">Especialidades /Gastroenterología<hr></span>
                        <span class="titulo">Expertos en tu <span class="tituloCirujia"> Bienestar </span></span>
                        <div class="instalacionesEspacio">
                            <span class="parrafo-check">
                                <p>
                                    La <b>gastroenterología</b> es la rama de la medicina que se enfoca en las enfermedades que afectan el tracto digestivo y órgano como el esófago, estómago, intestino, colon, recto, hígado y páncreas .
                                </p>
                            </span>
                        </div>
                    </div>
...
<div class="sec3-img-gastro">
    <div class="container">
         <div class="sec1gastro-text">
            <div class="col-sm-7">
                Entre los servicios más comunes que ofrecen los cinco especialistas en <b>Hospitaria</b> están:
            </div>
        </div>
        <div class="sec1gine2">
            <div class="col-sm-12">
                <div class="col-sm-5">
                    <p>- Nutrícion Clinica</p>
                    <p>- Endoscopias</p>
                    <p>- Bandas esofágicas</p>
                    <p>- Tratamiento de cáncer gastrointestinal</p>
                    <p>- Tratamiento de cáncer de páncreas</p>
                    <p>- Entre otros.</p>
                </div>
            </div>
        </div>
