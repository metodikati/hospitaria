...
<!------------------------Inicia la Parte del Banner-------------->
        ...
        <div class="sec1-cirugia">
            <div class="container">
                <div class="especialidadEspe">
                    <div class="col-sm-10 col-sm-offset-1">
                        <h1><span>Cirugía Plástica</span></h1>
                        <span class="especialidad1">
                            <p>Queremos lo mejor para tu <b>salud y belleza</b> </b></p> </span>
                    </div>
                </div>
            </div>
        </div>
			...
			<div class="col-sm-12 pd0">
                ...
                <div class="sec2-doc" >
                    <div class="col-sm-7 pd0">
                        ...
                        <p class="parrafoCirPlastica">
                            La cirugjía plástica es la especialidad médica que tiene como finalidad recuperar la normalidad funcional y estética por medio de la corrección de deformidades o malformaciones.
                        </p>
                        <p class="parrafoCirPlastica">
                        	Dentro de las técnicas de práctica más comunes se encuentran los trasplantes, movilización de tejidos, injertos, implantes, así como inyecciones de grasa y tratamientos a base de células madre.
                        </p>
        ...
        <div class="sec1gine2">
            <div class="col-sm-12">
                <div class="col-sm-3">
                    ...
                    <p>- Aumento de busto</p>
                    <p>- Rinoplastía</p>
                </div>
                <div class="col-sm-6">
                    <p>- Tratamiento de traumatismo</p>
                    <p>- Tratamiento de tumores</p>
                    <p>- Aumento de mentón</p>
                    <p>- Liposucción, entre otros</p>
                </div>
            </div>
        </div>
    </div>
