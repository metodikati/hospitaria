...
<!------------------------Inicia la Parte del Banner-------------->
        ...
        <div class="sec1-trauma">
            <div class="container">
                <div class="especialidadEspe">
                    <div class="col-sm-10 col-sm-offset-1">
                        <h1><span>Traumatología y Ortopedia</span></h1>
                    </div>
                </div>
            </div>
        </div>
			...
			<div class="col-sm-12 pd0">
                ...
                <div class="sec2-chec">
                    <div class="col-sm-8 pd0">
                    	<span class="sec1-lineaCirujia">Especialidades /Traumatología y Ortopedia<hr></span>
                        <span class="titulo">Los mejores tratamientos en <span class="tituloCirujia">Traumatología y Ortopedia</span></span>
                    </div>
                </div>
            </div>
		</div>
...
<div class="sec3-img-trauma">
    <div class="container">
         <div class="sec1trauma">
            <div class="col-sm-7">
                La <b>traumatología y ortopedia son dos ramas de la medicina que se especilizan en tratar lesiones del aparato locomotor como:</b>
            </div>
        </div>
        <div class="sec1trauma1">
            <div class="col-sm-12">
                <div class="col-sm-4">
                    <p>Fracturas</p>
                    <p>Lesiones de articulaciones y ligamentos</p>
                    <p> Esguinces</p>
                </div>
                <div class="col-sm-5">
                    <p>Hematomas</p>
                    <p>Problema de columna</p>
                </div>
            </div>
        </div>
    </div>
