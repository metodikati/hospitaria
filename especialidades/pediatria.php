...
<!------------------------Inicia la Parte del Banner-------------->
        ...
        <div class="sec1-pediatria">
            <div class="container">
                <div class="especialidadEspe">
                    <div class="col-sm-4 col-sm-offset-1">
                        <h1><span>Pediatría</span></h1>
                        <span class="especialidad1">
                            <p> Cuidamos  la SALUD de los niños</p> </span>
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12 pd0">
                ...
                <div class="sec2-chec">
                    <div class="col-sm-6 pd03">
                    	<span class="sec1-lineaCirujia">Especialidades /Pediatría<hr></span>
                        <span class="titulo">Especialistas en la<span class="tituloCirujia"> salud </span>de los más pequeños</span>
                    </div>
                </div>
            </div>
		</div>
...
<div class="parrafo-tit">
	<div class="container-fluid">
		<div class="col-sm-5 col-sm-offset-2 parrafo-tit1">
			<p>
				En Hospitaria, el <b>cuidado y la salud</b> de los pequeños es primordial, por lo que ofrecemos atención perzonalizada en distintas subespecialidades, de la pediatría como <b>neonatología, cardiología infantil, traumatismo pediátrico, otorrinolaringología, entre otros.</b>
			</p>
			<p><br><br><br>
				Actualmente contamos con <b>15 pediatras certificados</b> que le proporcionarán a su pequeño el mejor  servicio para su salud.
			</p>
		</div>
		<div class="col-sm-5">
			<img src="../assets/img/especialidades/pediatria-franja.png" class="img-responsive" alt="pediatria-franja">
		</div>
	</div>
</div>

<!---->
<div class="contacto-pediatria">
    <div class="container">
