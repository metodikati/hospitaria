            ...
            <div class="container">
                <div class="especialidadEspe">
                    <div class="col-sm-10 col-sm-offset-1">
                        ...
                        <h1><span class="especialidad1">Cuidando la salud de la MUJER</b></span></h1> 
                    </div>
                </div>
            </div>
        </div>
			...
			<div class="col-sm-12 pd0">
                ...
                <div class="sec2-chec">
                    <div class="col-sm-6 pd0">
                    	<span class="sec1-lineaCirujia">Especialidades /Ginecología y Obstetricia<hr></span>
                        <span class="titulo">Somos especialistas en la <span class="tituloCirujia">SALUD</span> de la mujer</span>
                        <div class="instalacionesEspacio">
                        	<span class="parrafo-check">
                        		<p>
                            		En Hospitaria buscamos priorizar y mantenernos a la vanguardia en el cuidado de la salud de la mujer, por lo que ofrecemos una gran variedad servicios orientados a la prevención y tratamiento de enfermedades femeninas a cargo de <span class="instalaciones-bold"> 30 especialistas certificados. </span>
                        		</p>
                        	</span>
                        </div>
                    </div>
        ...
        <div class="sec1gine2">
            <div class="col-sm-12">
                <div class="col-sm-3">
                    ...
                    <p>- Parto asistido</p>
                    <p>- Parto prematuro</p>
                    <p>- Trabajo de parto obstruído</p>
                    <p>- Amenza de aborto</p>
                </div>
                <div class="col-sm-6">
                    <p>- Tratamiento para cáncer de mama</p>
                    <p>- Tratamiento para cáncer de útero</p>
                    <p>- Papanicolaou</p>
                    <p>- Liomioma Uterino</p>
                    <p>- Desproporción fetopélvica y cefalopélvica, entre otros</p>
                </div>
            </div>
        </div>
    </div>
