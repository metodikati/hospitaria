...
<!------------------------Inicia la Parte del Banner-------------->
        ...
        <div class="sec1-cirugia-general">
            <div class="container">
                <div class="especialidadEspe">
                    <div class="col-sm-6 col-sm-offset-1">
                        <h1><span>Cirugía General</span></h1>
                        <span class="especialidad1">
                            <p> Queremos la mejor calidad para  ti</p> </span>
                    </div>
                </div>
            </div>
        </div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12 pd0">
                <div class="col-sm-2 col-xs-10 pd0">
                ...
                <div class="sec2-quienes">
                    <div class="col-sm-8 pd0">
                        <span class="sec1-lineaCirujia">Especialista / Cirugía General<hr></span>
                        <span class="titulo">
                            <span class="tituloCirujia">La MEJOR tecnología</span> para tu bienestar y comodidad
                        </span>
                    </div>
                </div>
            </div>
...
<div class="sec3-img">
    <div class="container">
        <div class="col-sm-7 col-sm-offset-1">
            <p>
                La unidad quirúrgica en <span class="parrafo-center">Hospitaria</span>   cuenta con <span class="parrafo-center"> 5 quirófanos</span>  de <span class="parrafo-center">última tecnología</span>  y <span>21 especialistas</span> altamente  calificados para brindar mayor <span class="parrafo-center">BIENESTAR Y COMODIDAD</span>  a nuestros pacientes.
            </p>
        </div>
    </div>
</div>

<div class="contacto-new">
    <div class="container">
