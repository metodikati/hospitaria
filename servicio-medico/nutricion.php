                ...
                <div class="especialidadQuirofano">
                    <div class="col-sm-6">
                        ...
                        <span class="especialidad1">
                            <p>
                            	Basada en buenos hábitos alimenticios
                            </p>
                        </span>
                    </div>
                </div>
                    ...
                    <div class="col-sm-7 pd0">
                        ...
                        <div class="instalacionesEspacio">
                        	<span class="parrafo-check">
                        		...
                        		<p>
                        			Dentro de los servicios médicos adicionales que se ofrecen en nuestro hospital, se encuentra el área de nutrición, ya que consideramos que alimentarse sanamente es esencial para desarrollar una buena salud.
                        		</p>
                        	</span>
                        </div>
                    </div>
...
<div class="sec3-nutricionN">
    <div class="container">
         <div class="sec1quienesSNutricion">
            <div class="col-sm-7">
                Los servicios que ofrecemos son los siguientes:
            </div>
        </div>
        <div class="sec1gine2Nutricioon">
            <div class="col-sm-12 movilParaSec3">
                <div class="col-sm-3">
                    <p>- Evaluaciones nutricionales</p>
                    <p>- Dietas y planes alimenticios</p>
                    <p>- Consultas y guías de alimentación </p>
                </div>
            </div>
        </div>
        <div class="col-sm-7">
            Adicionalmente, contamos con sesiones informativas que tienen la finalidad de concientizar a los pacientes sobre la importancia de llevar una alimentación balanceada para una salud óptima. 
        </div>
        </div>
    </div>
</div>
<div class="contactoNutricionN">
    <div class="container">
