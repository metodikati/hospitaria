...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Urgencias en Hospitaria buscamos cumplir con los más altos estándares de calidad">
...
<!------------------------Inicia la Parte del Banner-------------->
        ...
        <div class="sec1-urgencias-banner">
            <div class="container">
                <div class="especialidadEspe">
                    <div class="col-sm-10">
                        <span>Urgencias</span>
                        <h1><span class="especialidad1">Atención Clínica al instante</b></span></h1>
                    </div>
                </div>
            </div>
        </div>
			...
			<div class="col-sm-12 pd0">
                ...
                <div class="sec2-chec">
                    <div class="col-sm-6 pd0">
                    	<span class="sec1-lineaCirujia">Especialidades /Urgencias<hr></span>
                        <span class="titulo">Cuidando tu salud <span class="tituloCirujia">las 24 horas.</span></span>
...
<!---->
<div class="sec3-img-urgencias">
    <div class="container">
         <div class="sec1quienesS">
            <div class="col-sm-7">
                La sala de urgencias de Hospitaria está totalmente equipada y ofrece servicios de:
            </div>
        </div>
        <div class="sec1gine2">
            <div class="col-sm-12">
    ...
    <div class="container">
        <div class="text1-contacto">
            ...
            <div class="col-sm-4 col-sm-offset-4 col-xs-10">
                <a href="../contacto.php">
                    <img src="../assets/img/especialidades/boton.png" class="img-responsive" alt="Boton contacto">
                </a>
            </div>
