...
{{-- Menu Header --}}
@include('layout.back.partials.top-menu')

{{-- Menu Sidebar --}}
@include('layout.back.partials.sidebar-menu')
...
{{-- Classie js --}}
{{ Html::script('back/bower_components/classie/classie.js') }}
{{-- sweet alert js --}}
...
{{ Html::script('back/assets/js/classie.js') }}
{{-- Datatable --}}
